...
it tells any agent to `git clone https://github.com/toprmrproducer/Vied-dental`, run it, and deploy it
...
- LIVE on GitHub Pages: https://toprmrproducer.github.io/Vied-dental/ (teal) and /variant-blue/ (blue). Repo is public.
...
- Footer credit: "Crafted by RapidXAI" + "© 2026 Vied Dental".
- GitHub: private repo `toprmrproducer/Vied-dental`.
- Netlify: site `Vied-dental-blue.netlify.app` created but deploy BLOCKED (account credits exhausted).
